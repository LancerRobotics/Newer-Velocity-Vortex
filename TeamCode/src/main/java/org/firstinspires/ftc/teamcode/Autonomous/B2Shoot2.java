...
/**
 * Created by Paspuleti on 3/13/2017.
 */
@Autonomous(name = "2 Beacon Blue Shoot", group = "test")
public class B2Shoot2 extends LinearOpMode {
    ...
    public void runOpMode(){
        ...
        */
        ...
        while (!white_line && opModeIsActive() && !isStopRequested()) {
            ...
            Artemis.setDrivePower(Artemis.coast(65, Artemis.br.getCurrentPosition(), iPos));
        ...
        while (!white_line && opModeIsActive() && !isStopRequested()) {
            ...
            Artemis.fr.setPower(-.47);
            Artemis.br.setPower(.47);
            Artemis.fl.setPower(.47);
            Artemis.bl.setPower(-.47);
        }
        ...
        while (!white_line && opModeIsActive() && !isStopRequested()) {
            ...
            double power = Artemis.coastStrafe(80, Artemis.br.getCurrentPosition(), iPos, this);
            //double power = .4;
        ...
        while (!white_line && opModeIsActive() && !isStopRequested()) {
            ...
            Artemis.fr.setPower(.55);
            Artemis.br.setPower(-.55);
            Artemis.fl.setPower(-.55);
            Artemis.bl.setPower(.55);
        }
        AlignToWithinOf(90, 2, .31);
        Artemis.adjustToDistanceShlok(19, .145, this);
        telemetry.addLine("Detecting Color");
